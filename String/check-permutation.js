 ...
 * permutation comparison is case sensitive. That is: is Bat a permutiation of tab?
 ...
 * look at that definition you provided. Can you check the strings against that definition?
 * 
...
If two strings are permutations, then we know they have the same characters, but in different
...
// console.log(checkPermutation1('helwoj', 'helowj'));
...
console.log(checkPermutation('helwoje', 'heelowj'));
